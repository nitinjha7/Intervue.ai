...
const ResumePage = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,rgba(56,189,248,0.12),transparent_24%),radial-gradient(circle_at_top_right,rgba(244,114,182,0.08),transparent_22%),linear-gradient(180deg,rgba(2,6,23,1),rgba(2,6,23,0.94))] p-4 text-foreground sm:p-6">
      ...
      <div className="relative mx-auto flex min-h-[calc(100vh-2rem)] w-full max-w-7xl flex-col gap-4">
        ...
        <div className="grid min-h-0 gap-4 lg:grid-cols-[1.2fr_0.8fr]">
          <section className="rounded-3xl border border-white/10 bg-black/25 p-4 shadow-[0_20px_60px_rgba(0,0,0,0.28)] backdrop-blur">
            ...
            {loadingResumes ? (
              <div className="flex min-h-88 items-center justify-center text-sm text-slate-400">
                Loading resumes...
              </div>
              ...
              <div className="flex min-h-88 flex-col items-center justify-center gap-3 rounded-2xl border border-dashed border-white/10 bg-white/5 text-center">
          ...
          <div className="grid gap-4">
            <div className="grid gap-3">
              ...
              <Input
                id="title"
                name="title"
                placeholder="john_doe_sde_resume"
                value={resumeTitle}
